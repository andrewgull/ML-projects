...
```{r}
resamples_file <- "data/lrl_decorr_log1p_res_cv10_new_split.rds"
...
```{r}
# first submission 0.17780 / place 3682 out of 4672
write_csv(pred_submission_df, "data/prediction_submission_yj_log.csv", quote = "none")
```
